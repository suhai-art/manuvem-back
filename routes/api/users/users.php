...
Route::prefix('users')->middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('/', [UsersController::class, 'createUpdate'])->middleware(['can:user.create', 'can:role.view']);
    Route::get('/form-options', [UsersController::class, 'formOptions'])->middleware(['can:user.update', 'can:role.view']);
    Route::put('/{id}', [UsersController::class, 'createUpdate'])->middleware(['can:user.update', 'can:role.view']);
